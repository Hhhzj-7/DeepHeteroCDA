...
# Hyper Setting
cnn_hyper = [args.circRNA_NN_ninput, args.cnn_nhid, args.gat_ninput, args.cnn_nlayers]
...
for train_times in range(fold_num):
    ...
    model = DeepHeteroCDA(GAT_hyper=GAT_hyper, CNN_hyper=cnn_hyper, DNN_hyper=dnn_hyper, DECO_hyper=Deco_hyper,
